    ...
    <div class="row">
      <div class="col-12">  
        ...
        <%
        	...
        	if(isLongTime){
        %>
				<span style="text-decoration:blink; font-size:large; color:blue"> Your time is over! You have free this table for other customers. </span>
		<%
			}
		...
		%>
			<tr>
			  <td>Their Are No Orders Available</td>
			</tr>
		<%
			} 
		%>						
