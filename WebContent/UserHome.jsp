...
<head>
	...
	<title>ELSON Restaurant Ordering System</title>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
		...
		if(login.getUserName().equals("cook")){
		%>
			<h2>WELCOME BACK MR_NYONI, <%=login.getUserName() %>!</h2>
		<%
		} else{
		%>
			<h2>WELCOME TO ELSON VICNEX FOOD SYSTEM, Table <%=login.getUserName() %>!</h2>
		<%
		} 
		%>	
